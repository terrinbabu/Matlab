...
it_value = importdata('ijt_0kg_lift_v1a1.txt');
ft_value = importdata('fjt_0kg_lift_v1a1.txt');
et_value = importdata('ejt_0kg_lift_v1a1.txt');
mjs_value = importdata('mjt_0kg_lift_v1a1.txt');
rt_value = importdata('rjt_0kg_lift_v1a1.txt');
vf_value = importdata('vf_0kg_lift_v1a1.txt');
...
fit_value = importdata('ijt_0kg_lift_v1a1_pikf.txt');
fft_value = importdata('fjt_0kg_lift_v1a1_pikf.txt');
fet_value = importdata('ejt_0kg_lift_v1a1_pikf.txt');
fmjs_value = importdata('mjt_0kg_lift_v1a1_pikf.txt');
frt_value = importdata('rjt_0kg_lift_v1a1_pikf.txt');
fvf_value = importdata('vf_0kg_lift_v1a1_pikf.txt');
...
% save('3kg','eval_vf_time','fx','fy','fz');
% save('KF2_3kg','eval_fvf_time','ffx','ffy','ffz');

%% Position with filter
...
for i = 1:6
    ...
    plot(eval_it_time,roundn(it_value.data(start_trim+1:end-end_trim,i+14),3))
    hold on
    plot(eval_fit_time,roundn(fit_value.data(start_trim+1:end-end_trim,i+14),3),'r')
    ylabel('inertial')
    legend('org','filtered')
    ...
    plot(eval_ft_time,roundn(ft_value.data(start_trim+1:end-end_trim,i+14),3))
    hold on
    plot(eval_fft_time,roundn(fft_value.data(start_trim+1:end-end_trim,i+14),3),'r')
    ylabel('frictional')
    legend('org','filtered')
    ...
    plot(eval_et_time,roundn(et_value.data(start_trim+1:end-end_trim,i+14),3))
    hold on
    plot(eval_fet_time,roundn(fet_value.data(start_trim+1:end-end_trim,i+14),3),'r')
    ylabel('estimated')
    legend('org','filtered')
    ...
    plot(eval_mjs_time,roundn(mjs_value.data(start_trim+1:end-end_trim,i+14),3))
    hold on
    plot(eval_fmjs_time,roundn(fmjs_value.data(start_trim+1:end-end_trim,i+14),3),'r')
    ylabel('measured')
    legend('org','filtered')
    ...
    plot(eval_rt_time,roundn(rt_value.data(start_trim+1:end-end_trim,i+14),3))
    hold on
    plot(eval_frt_time,roundn(frt_value.data(start_trim+1:end-end_trim,i+14),3),'r')
    ylabel('residual')
    legend('org','filtered')
